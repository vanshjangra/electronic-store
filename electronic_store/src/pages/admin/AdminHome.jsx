...
const AdminHome = () => {
  return (
    <Container>
      ...
      <Row className="mt-5">
        <Col md={6}>
        <DashboardCardView icon={<MdOutlineProductionQuantityLimits size={80}/>}
                           text={'Number of Products'}
                           number={25254}/>
        </Col>

        <Col md={6}>
        <DashboardCardView icon={<MdOutlineCategory size={80}/>}
                           text={'Number of Categories'}
                           number={15}/>
        </Col>

        <Col md={6} className="mt-3">
        <DashboardCardView icon={<BsBorderStyle size={80}/>}
                           text={'Number of Orders'}
                           number={4545}/>
        </Col>

        <Col md={6} className="mt-3">
        <DashboardCardView icon={<FaUserSecret size={80}/>}
